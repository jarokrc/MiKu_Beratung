...
import cookiesImg from "@/assets/cookies/cookies.webp";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-[1.1fr,0.9fr] md:items-center">
        <div className="space-y-3">
          <h1 className="text-3xl font-bold text-[var(--ink)] md:text-4xl">{t.cookies.title}</h1>
      ...
      <div className="space-y-6">
        {t.cookies.sections.map((section, sectionIndex) => (
          <section
            ...
            className="space-y-3"
          >
            <h2 className="text-lg font-semibold text-[var(--ink)] md:text-xl">
              {section.heading}
            </h2>
